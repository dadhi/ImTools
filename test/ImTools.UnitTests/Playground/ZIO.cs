...
namespace ImTools.ImTools.UnitTests.Playground
{
    ...
    public sealed class ZAsync<A> : Z<A>
    {
        ...
        public ZLazy(Action<Action<A>> delay) => Delay = delay; 
    ...
    {
        public readonly Z<A> ZA;
        public readonly Func<A, ZA<B>> From;
        public ZThen(Z<A> za, Func<A, B> from) { ZA = za; From = from; } 
    ...
    public sealed class ZZip<A, B> : Z<(A, B)>
    {
        ...
        public ZMap(Z<A> za, Z<B> zb) { ZA = za; ZB = zb; } 
        public void Run(Action<B> consume) => ZA.Run(a => ZB.Run(b => consume((a, b))));
    }
    ...
    public static class Z
    {
        ...
        public static Z<B> AsVal<A, B>(this Z<A> za, B b) => new ZMap<A, B>(za, b.ToFunc); 
        public static Z<B> AsLazy<A, B>(this Z<A> za, Func<B> getB) => new ZMap<A, B>(za, _ => getB());
