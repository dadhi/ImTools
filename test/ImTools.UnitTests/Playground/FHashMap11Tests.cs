...
[TestFixture]
public class FHashMap11Tests
{
    internal static void Verify<K, V, TEq>(FHashMap11<K, V, TEq> map, IEnumerable<K> expectedKeys)
    ...
    public void Real_world_test_AddOrUpdate_NO_Resize()
    {
        ...
        var map = new FHashMap11<Type, string, RefEq<Type>>(8);
    ...
    */
    ...
    {
        var map = new FHashMap11<int, string, IntEq>(2);
        // var map = new FHashMap11<int, string, GoldenIntEq>(2);
    ...
    {
        FHashMap11<int, string, IntEq> map = default;
    ...
    {
        var map = new FHashMap11<int, string, IntEq>(1);
    ...
    {
        var map = new FHashMap11<int, string, IntEq>();
