...
namespace ImTools
{
    ...
    public class HashMapTwickedLinear<K, V, TEqualityComparer> where TEqualityComparer : struct, IEqualityComparer<K>
    {
...
#pragma warning restore 649
        ...
        public HashMapTwickedLinear(int initialCapacityBitCount = InitialCapacityBitCount)
        {
