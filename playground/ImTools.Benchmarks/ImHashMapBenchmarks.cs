...
|                   Method | Count |         Mean |       Error |       StdDev |       Median | Ratio | RatioSD |    Gen 0 | Gen 1 | Gen 2 | Allocated |
|------------------------- |------ |-------------:|------------:|-------------:|-------------:|------:|--------:|---------:|------:|------:|----------:|
|     V4_ImMap_AddOrUpdate |    10 |     409.6 ns |     8.18 ns |     17.96 ns |     403.8 ns |  1.00 |    0.00 |   0.3133 |     - |     - |     984 B |
| V3_ImHashMap_AddOrUpdate |    10 |     420.5 ns |     6.83 ns |     10.02 ns |     416.5 ns |  1.03 |    0.05 |   0.3185 |     - |     - |    1000 B |
|                          |       |              |             |              |              |       |         |          |       |       |           |
|     V4_ImMap_AddOrUpdate |   100 |  10,727.5 ns |   213.97 ns |    333.13 ns |  10,681.4 ns |  1.00 |    0.00 |   5.6610 |     - |     - |   17760 B |
| V3_ImHashMap_AddOrUpdate |   100 |  11,183.0 ns |   223.04 ns |    186.25 ns |  11,164.7 ns |  1.04 |    0.04 |   6.3782 |     - |     - |   20032 B |
|                          |       |              |             |              |              |       |         |          |       |       |           |
|     V4_ImMap_AddOrUpdate |  1000 | 358,366.4 ns | 7,152.46 ns | 17,545.11 ns | 351,770.2 ns |  1.00 |    0.00 |  90.8203 |     - |     - |  286048 B |
| V3_ImHashMap_AddOrUpdate |  1000 | 285,912.6 ns | 5,652.90 ns | 11,547.38 ns | 282,150.0 ns |  0.79 |    0.04 | 103.0273 |     - |     - |  324176 B |

|                   Method | Count |         Mean |       Error |       StdDev |       Median | Ratio | RatioSD |    Gen 0 |  Gen 1 | Gen 2 | Allocated |
|------------------------- |------ |-------------:|------------:|-------------:|-------------:|------:|--------:|---------:|-------:|------:|----------:|
|     V4_ImMap_AddOrUpdate |    10 |     406.6 ns |     7.93 ns |     18.37 ns |     398.5 ns |  1.00 |    0.00 |   0.3133 |      - |     - |     984 B |
| V3_ImHashMap_AddOrUpdate |    10 |     429.7 ns |    10.62 ns |     30.13 ns |     420.3 ns |  1.07 |    0.08 |   0.3185 |      - |     - |    1000 B |
|                          |       |              |             |              |              |       |         |          |        |       |           |
|     V4_ImMap_AddOrUpdate |   100 |  10,811.9 ns |   212.10 ns |    393.14 ns |  10,707.1 ns |  1.00 |    0.00 |   5.6458 |      - |     - |   17736 B |
| V3_ImHashMap_AddOrUpdate |   100 |  11,256.9 ns |   212.15 ns |    177.16 ns |  11,209.9 ns |  1.04 |    0.03 |   6.3782 |      - |     - |   20032 B |
|                          |       |              |             |              |              |       |         |          |        |       |           |
|     V4_ImMap_AddOrUpdate |  1000 | 349,253.1 ns | 6,841.97 ns | 11,618.18 ns | 345,756.6 ns |  1.00 |    0.00 |  90.8203 | 1.4648 |     - |  285352 B |
| V3_ImHashMap_AddOrUpdate |  1000 | 279,437.9 ns | 3,799.15 ns |  3,172.47 ns | 278,612.9 ns |  0.81 |    0.03 | 103.0273 |      - |     - |  324176 B |

|                   Method | Count |         Mean |       Error |       StdDev | Ratio | RatioSD |    Gen 0 | Gen 1 | Gen 2 | Allocated |
|------------------------- |------ |-------------:|------------:|-------------:|------:|--------:|---------:|------:|------:|----------:|
|     V4_ImMap_AddOrUpdate |    10 |     383.6 ns |     7.71 ns |     14.29 ns |  1.00 |    0.00 |   0.3133 |     - |     - |     984 B |
| V3_ImHashMap_AddOrUpdate |    10 |     406.9 ns |     7.86 ns |      9.36 ns |  1.06 |    0.04 |   0.3185 |     - |     - |    1000 B |
|                          |       |              |             |              |       |         |          |       |       |           |
|     V4_ImMap_AddOrUpdate |   100 |  10,687.4 ns |   197.07 ns |    323.78 ns |  1.00 |    0.00 |   5.6305 |     - |     - |   17696 B |
| V3_ImHashMap_AddOrUpdate |   100 |  11,424.2 ns |   224.79 ns |    448.93 ns |  1.07 |    0.06 |   6.3782 |     - |     - |   20032 B |
|                          |       |              |             |              |       |         |          |       |       |           |
|     V4_ImMap_AddOrUpdate |  1000 | 346,795.8 ns | 6,917.35 ns | 10,563.53 ns |  1.00 |    0.00 |  90.3320 |     - |     - |  284520 B |
| V3_ImHashMap_AddOrUpdate |  1000 | 284,017.3 ns | 5,531.02 ns |  6,792.59 ns |  0.82 |    0.02 | 103.0273 |     - |     - |  324176 B |
...
|                         Method | Count |      Mean |     Error |    StdDev | Ratio | RatioSD | Gen 0 | Gen 1 | Gen 2 | Allocated |
|------------------------------- |------ |----------:|----------:|----------:|------:|--------:|------:|------:|------:|----------:|
|     V4_ImMap_GetValueOrDefault |     1 |  7.033 ns | 0.0974 ns | 0.0864 ns |  1.00 |    0.00 |     - |     - |     - |         - |
| V3_ImHashMap_GetValueOrDefault |     1 |  6.672 ns | 0.0652 ns | 0.0509 ns |  0.95 |    0.01 |     - |     - |     - |         - |
|                                |       |           |           |           |       |         |       |       |       |           |
|     V4_ImMap_GetValueOrDefault |    10 |  7.960 ns | 0.1417 ns | 0.1256 ns |  1.00 |    0.00 |     - |     - |     - |         - |
| V3_ImHashMap_GetValueOrDefault |    10 |  7.055 ns | 0.1527 ns | 0.1428 ns |  0.89 |    0.02 |     - |     - |     - |         - |
|                                |       |           |           |           |       |         |       |       |       |           |
|     V4_ImMap_GetValueOrDefault |   100 | 13.331 ns | 0.2296 ns | 0.2035 ns |  1.00 |    0.00 |     - |     - |     - |         - |
| V3_ImHashMap_GetValueOrDefault |   100 | 10.337 ns | 0.1542 ns | 0.1367 ns |  0.78 |    0.01 |     - |     - |     - |         - |
|                                |       |           |           |           |       |         |       |       |       |           |
...
*/
            ...
            public void Populate()
            {
                ...
                _partMap23 = V3_PartitionedHashMap_AddOrUpdate();
            ...
            public string V3_PartitionedHashMap_GetValueOrDefault() =>
                _partMap23.GetValueOrDefaultByReferenceEquals(LookupKey);
            ...
            {
                var hash = LookupKey.GetHashCode();
                _partMap23[hash & ImToolsV3.PartitionedHashMap.PARTITION_HASH_MASK].TryFind(hash, LookupKey, out var result);
                return result;
            }
...
|                 Method | Count |         Mean |      Error |       StdDev |       Median | Ratio | RatioSD |  Gen 0 | Gen 1 | Gen 2 | Allocated |
|----------------------- |------ |-------------:|-----------:|-------------:|-------------:|------:|--------:|-------:|------:|------:|----------:|
|     V4_ImMap_Enumerate |     1 |     64.35 ns |   1.272 ns |     2.923 ns |     63.75 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V3_ImHashMap_Enumerate |     1 |     53.32 ns |   1.144 ns |     2.258 ns |     53.26 ns |  0.83 |    0.05 | 0.0510 |     - |     - |     160 B |
|                        |       |              |            |              |              |       |         |        |       |       |           |
|     V4_ImMap_Enumerate |    10 |    266.74 ns |   6.791 ns |    19.811 ns |    261.46 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V3_ImHashMap_Enumerate |    10 |    309.16 ns |   9.116 ns |    26.300 ns |    304.79 ns |  1.17 |    0.14 | 0.0763 |     - |     - |     240 B |
|                        |       |              |            |              |              |       |         |        |       |       |           |
|     V4_ImMap_Enumerate |   100 |  2,714.99 ns |  59.141 ns |   174.378 ns |  2,659.05 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V3_ImHashMap_Enumerate |   100 |  2,633.98 ns |  65.173 ns |   189.079 ns |  2,612.10 ns |  0.97 |    0.09 | 0.0763 |     - |     - |     240 B |
|                        |       |              |            |              |              |       |         |        |       |       |           |
|     V4_ImMap_Enumerate |  1000 | 30,927.26 ns | 617.635 ns | 1,711.465 ns | 30,572.87 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V3_ImHashMap_Enumerate |  1000 | 29,059.01 ns | 690.300 ns | 1,947.004 ns | 28,802.15 ns |  0.94 |    0.08 | 0.1526 |     - |     - |     480 B |
