...
|                    Method |  Count |            Mean |          Error |          StdDev | Ratio | RatioSD | Gen 0/1k Op | Gen 1/1k Op | Gen 2/1k Op | Allocated Memory/Op |
|-------------------------- |------- |----------------:|---------------:|----------------:|------:|--------:|------------:|------------:|------------:|--------------------:|
|         ImMap_AddOrUpdate |     10 |        698.2 ns |       2.090 ns |       1.8523 ns |  1.00 |    0.00 |      0.4435 |           - |           - |              2096 B |
|    ImMapArray_AddOrUpdate |     10 |        380.5 ns |       1.280 ns |       0.9991 ns |  0.54 |    0.00 |      0.2017 |           - |           - |               952 B |
| DictSlim_GetOrAddValueRef |     10 |        430.8 ns |       2.452 ns |       1.9146 ns |  0.62 |    0.00 |      0.2437 |           - |           - |              1152 B |
|                           |        |                 |                |                 |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |    100 |     13,581.3 ns |     210.366 ns |     196.7767 ns |  1.00 |    0.00 |      7.9651 |           - |           - |             37616 B |
|    ImMapArray_AddOrUpdate |    100 |      6,761.7 ns |     125.461 ns |     117.3563 ns |  0.50 |    0.01 |      3.7994 |           - |           - |             17944 B |
| DictSlim_GetOrAddValueRef |    100 |      3,493.1 ns |       8.217 ns |       6.8614 ns |  0.26 |    0.00 |      1.8311 |      0.0038 |           - |              8656 B |
|                           |        |                 |                |                 |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |   1000 |    211,216.4 ns |   5,049.560 ns |   4,723.3619 ns |  1.00 |    0.00 |    113.0371 |      0.2441 |           - |            534464 B |
|    ImMapArray_AddOrUpdate |   1000 |    135,305.3 ns |   1,338.479 ns |   1,186.5272 ns |  0.64 |    0.01 |     71.7773 |      0.4883 |           - |            339736 B |
| DictSlim_GetOrAddValueRef |   1000 |     33,142.8 ns |     303.066 ns |     283.4879 ns |  0.16 |    0.00 |     15.5029 |      0.0610 |           - |             73440 B |
|                           |        |                 |                |                 |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |  10000 |  4,573,183.4 ns |  23,944.216 ns |  21,225.9239 ns |  1.00 |    0.00 |   1117.1875 |    242.1875 |    109.3750 |           7044992 B |
|    ImMapArray_AddOrUpdate |  10000 |  3,183,678.4 ns |  21,542.325 ns |  20,150.7041 ns |  0.70 |    0.01 |    882.8125 |    402.3438 |           - |           5119192 B |
| DictSlim_GetOrAddValueRef |  10000 |    478,191.8 ns |   3,091.915 ns |   2,892.1791 ns |  0.10 |    0.00 |    125.0000 |    124.5117 |    124.5117 |           1048032 B |
|                           |        |                 |                |                 |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate | 100000 | 65,664,920.7 ns | 900,608.445 ns | 842,429.6981 ns |  1.00 |    0.00 |  14375.0000 |   2250.0000 |    625.0000 |          86499835 B |
|    ImMapArray_AddOrUpdate | 100000 | 61,327,491.4 ns | 917,850.813 ns | 858,558.2196 ns |  0.93 |    0.02 |  11222.2222 |   1888.8889 |    666.6667 |          67292263 B |
