...
## Reuse newLeft/newRight in re-balancing the classical tree

|            Method |  Count |            Mean |         Error |        StdDev | Ratio | RatioSD |      Gen 0 |     Gen 1 |    Gen 2 |   Allocated |
|------------------ |------- |----------------:|--------------:|--------------:|------:|--------:|-----------:|----------:|---------:|------------:|
| ImMap_AddOrUpdate |     10 |        632.1 ns |       6.47 ns |       5.73 ns |  1.00 |    0.00 |     0.3567 |    0.0010 |        - |     1.64 KB |
|  ImMap_FixedData2 |     10 |        605.3 ns |       1.20 ns |       1.06 ns |  0.96 |    0.01 |     0.3023 |    0.0010 |        - |     1.39 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |    100 |     12,142.0 ns |      84.58 ns |      79.11 ns |  1.00 |    0.00 |     7.4768 |    0.3052 |        - |    34.36 KB |
|  ImMap_FixedData2 |    100 |     13,725.3 ns |      22.35 ns |      20.90 ns |  1.13 |    0.01 |     7.0801 |    0.3204 |        - |    32.56 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |   1000 |    200,789.6 ns |   3,808.28 ns |   3,910.82 ns |  1.00 |    0.00 |   108.3984 |    0.2441 |        - |   498.61 KB |
|  ImMap_FixedData2 |   1000 |    228,106.3 ns |   4,471.75 ns |   4,182.88 ns |  1.13 |    0.04 |   104.9805 |    0.2441 |        - |   482.61 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |  10000 |  4,286,121.6 ns |  43,283.36 ns |  38,369.58 ns |  1.00 |    0.00 |  1070.3125 |  257.8125 |  93.7500 |  6575.53 KB |
|  ImMap_FixedData2 |  10000 |  4,978,385.3 ns |  20,153.33 ns |  18,851.43 ns |  1.16 |    0.01 |  1046.8750 |  304.6875 | 117.1875 |  6418.67 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate | 100000 | 60,749,346.0 ns | 261,446.39 ns | 231,765.42 ns |  1.00 |    0.00 | 13666.6667 | 1777.7778 | 444.4444 | 81355.74 KB |
|  ImMap_FixedData2 | 100000 | 72,716,285.7 ns | 493,298.72 ns | 461,431.92 ns |  1.20 |    0.01 | 13571.4286 | 2285.7143 | 571.4286 | 79793.39 KB |
