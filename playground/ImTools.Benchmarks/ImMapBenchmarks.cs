...
|            Method |  Count |            Mean |         Error |        StdDev | Ratio | RatioSD |      Gen 0 |     Gen 1 |    Gen 2 |   Allocated |
|------------------ |------- |----------------:|--------------:|--------------:|------:|--------:|-----------:|----------:|---------:|------------:|
| ImMap_AddOrUpdate |     10 |        625.3 ns |       2.09 ns |       1.74 ns |  1.00 |    0.00 |     0.3567 |    0.0010 |        - |     1.64 KB |
|  ImMap_FixedData4 |     10 |        496.7 ns |       1.37 ns |       1.22 ns |  0.79 |    0.00 |     0.2813 |    0.0010 |        - |      1.3 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |    100 |     12,193.0 ns |      42.11 ns |      35.17 ns |  1.00 |    0.00 |     7.4768 |    0.3052 |        - |    34.36 KB |
|  ImMap_FixedData4 |    100 |     10,838.9 ns |      26.66 ns |      24.94 ns |  0.89 |    0.00 |     6.6376 |    0.3052 |        - |     30.5 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |   1000 |    201,595.3 ns |   3,965.38 ns |   5,014.94 ns |  1.00 |    0.00 |   108.3984 |    0.2441 |        - |   498.61 KB |
|  ImMap_FixedData4 |   1000 |    185,606.1 ns |   3,250.81 ns |   3,040.81 ns |  0.92 |    0.03 |    99.8535 |    0.2441 |        - |   459.59 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |  10000 |  4,233,982.8 ns |  28,572.44 ns |  26,726.67 ns |  1.00 |    0.00 |  1070.3125 |  257.8125 |  93.7500 |  6575.49 KB |
|  ImMap_FixedData4 |  10000 |  4,418,991.2 ns |  28,934.72 ns |  25,649.88 ns |  1.04 |    0.01 |  1007.8125 |  335.9375 | 140.6250 |  6184.95 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate | 100000 | 60,747,981.5 ns | 851,680.23 ns | 796,662.21 ns |  1.00 |    0.00 | 13666.6667 | 1777.7778 | 444.4444 | 81355.74 KB |
|  ImMap_FixedData4 | 100000 | 66,410,854.2 ns | 725,316.76 ns | 678,461.75 ns |  1.09 |    0.02 | 13250.0000 | 2250.0000 | 625.0000 | 77451.21 KB |
