...
|            Method |  Count |            Mean |         Error |        StdDev | Ratio | RatioSD |      Gen 0 |     Gen 1 |    Gen 2 |   Allocated |
|------------------ |------- |----------------:|--------------:|--------------:|------:|--------:|-----------:|----------:|---------:|------------:|
| ImMap_AddOrUpdate |     10 |        641.9 ns |      10.94 ns |      10.24 ns |  1.00 |    0.00 |     0.3567 |    0.0010 |        - |     1.64 KB |
|  ImMap_FixedData4 |     10 |        515.0 ns |      12.62 ns |      11.80 ns |  0.80 |    0.03 |     0.2813 |    0.0010 |        - |      1.3 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |    100 |     12,352.4 ns |      84.22 ns |      78.78 ns |  1.00 |    0.00 |     7.4768 |    0.3052 |        - |    34.36 KB |
|  ImMap_FixedData4 |    100 |     11,162.2 ns |      27.26 ns |      24.16 ns |  0.90 |    0.01 |     6.6376 |    0.3052 |        - |     30.5 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |   1000 |    196,971.8 ns |   1,699.15 ns |   1,418.87 ns |  1.00 |    0.00 |   108.3984 |    0.2441 |        - |   498.61 KB |
|  ImMap_FixedData4 |   1000 |    191,968.2 ns |     718.37 ns |     671.97 ns |  0.97 |    0.01 |    99.8535 |    0.2441 |        - |   459.59 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate |  10000 |  4,249,235.4 ns |  32,365.38 ns |  28,691.06 ns |  1.00 |    0.00 |  1070.3125 |  257.8125 |  93.7500 |  6575.53 KB |
|  ImMap_FixedData4 |  10000 |  4,509,994.2 ns |   9,767.42 ns |   8,658.56 ns |  1.06 |    0.01 |  1007.8125 |  343.7500 | 140.6250 |  6184.91 KB |
|                   |        |                 |               |               |       |         |            |           |          |             |
| ImMap_AddOrUpdate | 100000 | 60,343,829.6 ns | 811,365.37 ns | 758,951.67 ns |  1.00 |    0.00 | 13666.6667 | 1777.7778 | 444.4444 | 81357.23 KB |
