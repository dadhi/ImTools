...
|                    Method | Count |         Mean |         Error |         StdDev |       Median | Ratio | RatioSD | Gen 0/1k Op | Gen 1/1k Op | Gen 2/1k Op | Allocated Memory/Op |
|-------------------------- |------ |-------------:|--------------:|---------------:|-------------:|------:|--------:|------------:|------------:|------------:|--------------------:|
|         ImMap_AddOrUpdate |    10 |     683.3 ns |     3.5322 ns |      3.3040 ns |     683.5 ns |  1.00 |    0.00 |      0.4435 |           - |           - |              2096 B |
|    ImMapArray_AddOrUpdate |    10 |     521.4 ns |     2.4322 ns |      2.2751 ns |     521.6 ns |  0.76 |    0.00 |      0.1726 |           - |           - |               816 B |
| DictSlim_GetOrAddValueRef |    10 |     430.4 ns |     0.8262 ns |      0.7728 ns |     430.6 ns |  0.63 |    0.00 |      0.2437 |           - |           - |              1152 B |
|                           |       |              |               |                |              |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |   100 |  11,927.3 ns |    72.9546 ns |     64.6724 ns |  11,922.5 ns |  1.00 |    0.00 |      7.9651 |           - |           - |             37616 B |
|    ImMapArray_AddOrUpdate |   100 |  16,672.4 ns |    38.5745 ns |     34.1953 ns |  16,663.7 ns |  1.40 |    0.01 |      3.3569 |           - |           - |             15920 B |
| DictSlim_GetOrAddValueRef |   100 |   3,495.6 ns |     9.4895 ns |      8.8765 ns |   3,493.1 ns |  0.29 |    0.00 |      1.8311 |      0.0038 |           - |              8656 B |
|                           |       |              |               |                |              |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |  1000 | 224,595.7 ns | 4,486.0268 ns | 11,171.7635 ns | 230,012.4 ns |  1.00 |    0.00 |    113.0371 |      0.2441 |           - |            534464 B |
|    ImMapArray_AddOrUpdate |  1000 | 540,013.8 ns | 3,815.1386 ns |  3,568.6830 ns | 539,735.5 ns |  2.61 |    0.17 |     71.2891 |      0.9766 |           - |            336560 B |
| DictSlim_GetOrAddValueRef |  1000 |  37,763.1 ns |   726.0466 ns |    713.0748 ns |  37,902.3 ns |  0.18 |    0.01 |     15.5029 |      0.0610 |           - |             73440 B |
