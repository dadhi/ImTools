...
## New ImMap.AddOrUpdate(, out _, out)

|                    Method |  Count |            Mean |             Error |            StdDev | Ratio | RatioSD | Gen 0/1k Op | Gen 1/1k Op | Gen 2/1k Op | Allocated Memory/Op |
|-------------------------- |------- |----------------:|------------------:|------------------:|------:|--------:|------------:|------------:|------------:|--------------------:|
|         ImMap_AddOrUpdate |     10 |        685.9 ns |         2.6461 ns |         2.4752 ns |  1.00 |    0.00 |      0.4435 |           - |           - |              2096 B |
|    ImMapArray_AddOrUpdate |     10 |        375.7 ns |         0.6729 ns |         0.5966 ns |  0.55 |    0.00 |      0.2017 |           - |           - |               952 B |
| DictSlim_GetOrAddValueRef |     10 |        426.7 ns |         1.1613 ns |         1.0294 ns |  0.62 |    0.00 |      0.2437 |           - |           - |              1152 B |
|                           |        |                 |                   |                   |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |    100 |     12,882.1 ns |       250.9426 ns |       257.6996 ns |  1.00 |    0.00 |      7.9651 |           - |           - |             37616 B |
|    ImMapArray_AddOrUpdate |    100 |      6,518.9 ns |        31.9783 ns |        28.3480 ns |  0.51 |    0.01 |      3.7994 |           - |           - |             17944 B |
| DictSlim_GetOrAddValueRef |    100 |      3,499.8 ns |        47.9996 ns |        44.8988 ns |  0.27 |    0.01 |      1.8311 |      0.0038 |           - |              8656 B |
|                           |        |                 |                   |                   |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |   1000 |    202,966.1 ns |     3,082.5265 ns |     2,574.0492 ns |  1.00 |    0.00 |    113.0371 |      0.2441 |           - |            534464 B |
|    ImMapArray_AddOrUpdate |   1000 |    128,717.2 ns |       519.3646 ns |       485.8140 ns |  0.63 |    0.01 |     71.7773 |      0.4883 |           - |            339736 B |
| DictSlim_GetOrAddValueRef |   1000 |     32,950.4 ns |        45.3750 ns |        37.8902 ns |  0.16 |    0.00 |     15.5029 |      0.0610 |           - |             73440 B |
|                           |        |                 |                   |                   |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate |  10000 |  4,361,188.3 ns |    25,059.1933 ns |    23,440.3850 ns |  1.00 |    0.00 |   1117.1875 |    242.1875 |    109.3750 |           7044992 B |
|    ImMapArray_AddOrUpdate |  10000 |  3,145,407.9 ns |    20,663.9538 ns |    19,329.0752 ns |  0.72 |    0.01 |    882.8125 |    402.3438 |           - |           5119192 B |
| DictSlim_GetOrAddValueRef |  10000 |    484,030.0 ns |     8,970.3421 ns |     9,211.8809 ns |  0.11 |    0.00 |    125.0000 |    124.5117 |    124.5117 |           1048032 B |
|                           |        |                 |                   |                   |       |         |             |             |             |                     |
|         ImMap_AddOrUpdate | 100000 | 66,726,977.0 ns |   755,405.7146 ns |   669,647.4900 ns |  1.00 |    0.00 |  14375.0000 |   2250.0000 |    625.0000 |          86499831 B |
|    ImMapArray_AddOrUpdate | 100000 | 65,728,976.9 ns | 1,266,248.7358 ns | 1,690,405.6918 ns |  0.99 |    0.03 |  11250.0000 |   2000.0000 |    750.0000 |          67292260 B |
| DictSlim_GetOrAddValueRef | 100000 | 11,144,014.2 ns |   139,326.2998 ns |   130,325.9073 ns |  0.17 |    0.00 |   1234.3750 |    968.7500 |    734.3750 |           9235953 B |
