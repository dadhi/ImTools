...
|               Method | Count |            Mean |          Error |         StdDev | Ratio | RatioSD |     Gen 0 |    Gen 1 |    Gen 2 | Allocated |
|--------------------- |------ |----------------:|---------------:|---------------:|------:|--------:|----------:|---------:|---------:|----------:|
| V4_ImMap_AddOrUpdate |     1 |        13.13 ns |       0.267 ns |       0.250 ns |  1.00 |    0.00 |    0.0051 |        - |        - |      32 B |
| V2_ImMap_AddOrUpdate |     1 |        15.84 ns |       0.312 ns |       0.276 ns |  1.21 |    0.01 |    0.0076 |        - |        - |      48 B |
|                      |       |                 |                |                |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate |    10 |       273.36 ns |       4.989 ns |       4.667 ns |  1.00 |    0.00 |    0.1173 |        - |        - |     736 B |
| V2_ImMap_AddOrUpdate |    10 |       697.77 ns |       6.789 ns |       6.350 ns |  2.55 |    0.05 |    0.2823 |        - |        - |    1776 B |
|                      |       |                 |                |                |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate |   100 |    10,901.48 ns |     111.713 ns |      99.031 ns |  1.00 |    0.00 |    2.9144 |   0.1221 |        - |   18320 B |
| V2_ImMap_AddOrUpdate |   100 |    14,534.30 ns |     172.609 ns |     153.014 ns |  1.33 |    0.02 |    5.9357 |   0.2441 |        - |   37296 B |
|                      |       |                 |                |                |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate |  1000 |   220,622.59 ns |   1,935.873 ns |   1,716.101 ns |  1.00 |    0.00 |   46.1426 |   4.8828 |        - |  290336 B |
| V2_ImMap_AddOrUpdate |  1000 |   242,464.60 ns |   2,100.765 ns |   1,965.057 ns |  1.10 |    0.01 |   84.9609 |   0.4883 |        - |  534144 B |
|                      |       |                 |                |                |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate | 10000 | 5,231,344.31 ns |  88,991.477 ns |  78,888.626 ns |  1.00 |    0.00 |  625.0000 | 312.5000 |  31.2500 | 3960456 B |
| V2_ImMap_AddOrUpdate | 10000 | 5,619,220.31 ns | 105,113.774 ns | 169,739.151 ns |  1.08 |    0.04 | 1109.3750 | 226.5625 | 101.5625 | 6972711 B |

|               Method | Count |            Mean |          Error |         StdDev |          Median | Ratio | RatioSD |     Gen 0 |    Gen 1 |    Gen 2 | Allocated |
|--------------------- |------ |----------------:|---------------:|---------------:|----------------:|------:|--------:|----------:|---------:|---------:|----------:|
| V4_ImMap_AddOrUpdate |     1 |        14.16 ns |       0.372 ns |       1.025 ns |        13.91 ns |  1.00 |    0.00 |    0.0102 |        - |        - |      32 B |
| V2_ImMap_AddOrUpdate |     1 |        18.23 ns |       0.453 ns |       1.241 ns |        18.04 ns |  1.29 |    0.14 |    0.0153 |        - |        - |      48 B |
|                      |       |                 |                |                |                 |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate |    10 |       288.32 ns |       5.845 ns |      14.877 ns |       285.68 ns |  1.00 |    0.00 |    0.2346 |        - |        - |     736 B |
| V2_ImMap_AddOrUpdate |    10 |       728.22 ns |      14.111 ns |      26.847 ns |       723.40 ns |  2.51 |    0.13 |    0.5655 |        - |        - |    1776 B |
|                      |       |                 |                |                |                 |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate |   100 |    10,640.62 ns |     200.046 ns |     413.130 ns |    10,633.20 ns |  1.00 |    0.00 |    5.8899 |        - |        - |   18496 B |
| V2_ImMap_AddOrUpdate |   100 |    16,142.05 ns |     322.957 ns |     798.269 ns |    15,993.71 ns |  1.52 |    0.09 |   11.8713 |        - |        - |   37296 B |
|                      |       |                 |                |                |                 |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate |  1000 |   242,403.94 ns |   4,843.733 ns |  13,095.313 ns |   238,227.47 ns |  1.00 |    0.00 |   86.6699 |  18.5547 |        - |  291784 B |
| V2_ImMap_AddOrUpdate |  1000 |   300,942.57 ns |   5,985.883 ns |  11,532.764 ns |   299,313.04 ns |  1.23 |    0.09 |  169.9219 |   0.4883 |        - |  534144 B |
|                      |       |                 |                |                |                 |       |         |           |          |          |           |
| V4_ImMap_AddOrUpdate | 10000 | 6,212,940.34 ns | 123,467.580 ns | 295,820.436 ns | 6,138,655.08 ns |  1.00 |    0.00 |  632.8125 | 312.5000 |  39.0625 | 3973929 B |
| V2_ImMap_AddOrUpdate | 10000 | 6,867,323.34 ns | 165,841.892 ns | 456,776.734 ns | 6,703,048.05 ns |  1.11 |    0.10 | 1109.3750 | 250.0000 | 109.3750 | 6972712 B |
...
|           Method | Count |          Mean |        Error |        StdDev |        Median | Ratio | RatioSD |  Gen 0 | Gen 1 | Gen 2 | Allocated |
|----------------- |------ |--------------:|-------------:|--------------:|--------------:|------:|--------:|-------:|------:|------:|----------:|
| V4_ImMap_foreach |     1 |      52.93 ns |     1.157 ns |      2.680 ns |      51.90 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V2_ImMap_foreach |     1 |      33.16 ns |     0.731 ns |      1.476 ns |      33.03 ns |  0.63 |    0.04 | 0.0229 |     - |     - |      72 B |
|                  |       |               |              |               |               |       |         |        |       |       |           |
| V4_ImMap_foreach |    10 |     200.61 ns |     4.102 ns |      7.604 ns |     198.29 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V2_ImMap_foreach |    10 |     161.72 ns |     3.306 ns |      8.048 ns |     160.30 ns |  0.81 |    0.04 | 0.0355 |     - |     - |     112 B |
|                  |       |               |              |               |               |       |         |        |       |       |           |
| V4_ImMap_foreach |   100 |   2,150.59 ns |    42.489 ns |     88.690 ns |   2,129.49 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V2_ImMap_foreach |   100 |   1,436.88 ns |    28.289 ns |     47.265 ns |   1,431.94 ns |  0.67 |    0.03 | 0.0420 |     - |     - |     136 B |
|                  |       |               |              |               |               |       |         |        |       |       |           |
| V4_ImMap_foreach |  1000 |  22,499.22 ns |   445.882 ns |    859.064 ns |  22,326.18 ns |  1.00 |    0.00 |      - |     - |     - |         - |
| V2_ImMap_foreach |  1000 |  15,364.59 ns |   357.361 ns |  1,007.944 ns |  15,105.46 ns |  0.69 |    0.06 | 0.0458 |     - |     - |     160 B |
|                  |       |               |              |               |               |       |         |        |       |       |           |
| V4_ImMap_foreach | 10000 | 231,529.70 ns | 4,420.440 ns | 10,419.497 ns | 228,931.93 ns |  1.00 |    0.00 |      - |     - |     - |     176 B |
| V2_ImMap_foreach | 10000 | 167,952.56 ns | 3,173.812 ns |  2,650.277 ns | 168,116.59 ns |  0.73 |    0.03 |      - |     - |     - |     192 B |
