...
using static FHashMap10;

public static class FHashMap10
{
    ...
    public static FHashMap10<K, V, TEq, SingleArrayEntries<K, V, TEq>> New<K, V, TEq>(byte capacityBitShift = 0)
        where TEq : struct, IEq<K> =>
        new FHashMap10<K, V, TEq, SingleArrayEntries<K, V, TEq>>(capacityBitShift);
    ...
    [MethodImpl((MethodImplOptions)256)]
    public static FHashMap10<K, V, TEq, ChunkedArrayEntries<K, V, TEq>> NewChunked<K, V, TEq>(byte capacityBitShift = 0)
        where TEq : struct, IEq<K> =>
        new FHashMap10<K, V, TEq, ChunkedArrayEntries<K, V, TEq>>(capacityBitShift);
    ...
    public static DebugHashItem<K, V>[] Explain<K, V, TEq, TEntries>(this FHashMap10<K, V, TEq, TEntries> map)
        where TEq : struct, IEq<K>
    ...
    public static void VerifyHashesAndKeysEq<K, V, TEq, TEntries>(this FHashMap10<K, V, TEq, TEntries> map, Action<bool> assertEq)
        where TEq : struct, IEq<K>
        where TEntries : struct, IEntries<K, V, TEq>
    {
        var exp = map.Explain();
    ...
    public static void VerifyNoDuplicateKeys<K, V, TEq, TEntries>(this FHashMap10<K, V, TEq, TEntries> map, Action<K> assertKey)
        where TEq : struct, IEq<K>
        where TEntries : struct, IEntries<K, V, TEq>
    {
    ...
    public static void VerifyProbesAreFitRobinHood<K, V, TEq, TEntries>(this FHashMap10<K, V, TEq, TEntries> map, Action<string> reportFail)
        where TEq : struct, IEq<K>
        where TEntries : struct, IEntries<K, V, TEq>
    {
        var hashes = map.PackedHashesAndIndexes;
    ...
    public static void VerifyContainAllKeys<K, V, TEq, TEntries>(this FHashMap10<K, V, TEq, TEntries> map, IEnumerable<K> expectedKeys, Action<bool, K> assertContainKey)
        where TEq : struct, IEq<K>
        where TEntries : struct, IEntries<K, V, TEq>
    {
    ...
    public class DebugProxy<K, V, TEq, TEntries>
        ...
        where TEntries : struct, IEntries<K, V, TEq>
    {
        private readonly FHashMap10<K, V, TEq, TEntries> _map;
        public DebugProxy(FHashMap10<K, V, TEq, TEntries> map) => _map = map;
...
public struct FHashMap10<K, V, TEq, TEntries> : IReadOnlyCollection<Entry<K, V>>
    where TEq : struct, IEq<K>
    where TEntries : struct, IEntries<K, V, TEq>
{
#if DEBUG
    ...
    public FHashMap10(byte capacityBitShift)
    {
