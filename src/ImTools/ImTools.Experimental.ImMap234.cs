        ...
        public static ImMap<V> AddOrUpdateEntry<V>(this ImMap<V> map, ImMapEntry<V> entry)
        {
            ...
            if (map is ImMapBranch2<V> br2)
            {
                ...
                if (key > br2.Entry0.Key)
                {
                    ...
                    var newBranch1 = br2.Branch1.AddOrUpdateEntry(entry);
                    
                    if (newBranch1 is ImMapBranch2<V> newBr2)
                        return new ImMapBranch3<V>(br2.Entry0, br2.Branch0, newBr2.Branch0, newBr2.Entry0, newBr2.Branch1);

                    // return new ImMapBranch2<V>();
                }
            }
