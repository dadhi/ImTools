...
{
    [TestFixture]
    public class ImHashMapForestTests
    {
        [Test]
        public void Tree_should_support_arbitrary_keys_by_using_their_hash_code()
        {
            var tree = ImHashMapForest<Type, string>.Empty;

            var key = typeof(ImHashMapForestTests);
            var value = "test";
        ...
        public void When_adding_value_with_hash_conflicted_key_Then_I_should_be_able_to_get_it_back()
        {
            ...
            var tree = ImHashMapForest<HashConflictingKey<string>, int>.Empty
                .AddOrUpdate(key1, 1)
                .AddOrUpdate(key2, 2)
                .AddOrUpdate(key3, 3);
        ...
        {
            var t = ImHashMapForest<int, int>.Empty
                .AddOrUpdate(1, 11)
                .AddOrUpdate(2, 22)
                .AddOrUpdate(3, 33);
        ...
        {
            var tree = ImHashMapForest<int, int>.Empty;
        ...
        {
            var tree = ImHashMapForest<int, string>.Empty
                .AddOrUpdate(1, "x")
                .AddOrUpdate(1, "y");
        ...
        {
            var tree = ImHashMapForest<int, string>.Empty.AddOrUpdate(0, "a");
        ...
        {
            var tree = ImHashMapForest<int, string>.Empty.Remove(0);
            Assert.That(tree.IsEmpty, Is.True);
        }
        ...
        {
            var tree = ImHashMapForest<HashConflictingKey<int>, string>.Empty
